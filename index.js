...
// Optional API key slot for future integrations (not needed by Edge TTS)
...
app.get("/", (_req, res) => {
  res.json({
    name: "Hindi TTS API",
    endpoints: ["/health", "POST /api/tts", "GET /api/audio/:file"],
  });
});
...
app.listen(PORT, () => {
  console.log(`Hindi TTS backend running on port ${PORT}`);
